...
namespace EF.Core.Data
{
	public partial class Class : BaseEntity
	{
		...
		//}
		//public virtual ICollection<ClassAssessment> ClassAssessments
		//{
		//	get { return _ClassAssessments ?? (_ClassAssessments = new List<ClassAssessment>()); }
		//	protected set { _ClassAssessments = value; }
		//}
