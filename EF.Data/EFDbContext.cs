...
namespace EF.Data
{
    public class EFDbContext : TrackerContext, IDbContext
    {
        ...
        /// <returns></returns>
        public static EFDbContext Create(string nameOrConnectionString)
        {
            ...
            entityBuilder.Metadata = @"res://*/Database.EFDbH.EFDbModel.csdl|res://*/Database.EFDb.EFDbModel.ssdl|res://*/Database.EFDb.EFDbModel.msl";

            return new EFDbContext(entityBuilder.ConnectionString);
        }
