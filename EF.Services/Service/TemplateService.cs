...
namespace EF.Services.Service
{
	public class TemplateService : ITemplateService
	{
		...
		public IList<Template> GetAllTemplates(bool active = false)
		{
			if (active)
				return _templateRepository.Table.Where(x => x.IsActive).ToList();

			return _templateRepository.Table.ToList();
		}
