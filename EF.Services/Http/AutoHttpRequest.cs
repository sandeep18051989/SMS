...
{
    public class AutoHttpRequest : HttpRequestBase
    {
        ...
        public AutoHttpRequest(string relativeUrl, string method,
        ...
        public AutoHttpRequest(string relativeUrl, string method, Uri url, Uri urlReferrer,
            NameValueCollection formParams, NameValueCollection queryStringParams,
            HttpCookieCollection cookies, NameValueCollection serverVariables)
        ...
        public AutoHttpRequest(string relativeUrl, Uri url, Uri urlReferrer)
