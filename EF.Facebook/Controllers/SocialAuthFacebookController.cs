...
namespace EF.Facebook.Controllers
{
    public class SocialAuthFacebookController : BaseSocialController
    {
        ...
        public ActionResult Configure()
        {
            ...
            model.DisplayName = "Facebook Settings";
            return View("~/Plugins/EF.Facebook/Views/SocialAuthFacebook/Configure.cshtml", model);
        }
        ...
        {
            return View("~/Plugins/EF.Facebook/Views/SocialAuthFacebook/Info.cshtml");
        }
